...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FrameworkAgentSpec) DeepCopyInto(out *FrameworkAgentSpec) {
	*out = *in
	if in.Git != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FrameworkAgentSpec.
func (in *FrameworkAgentSpec) DeepCopy() *FrameworkAgentSpec {
	if in == nil {
		return nil
	}
	out := new(FrameworkAgentSpec)
	in.DeepCopyInto(out)
	return out
}
