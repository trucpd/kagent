...
type MessageHandler interface {
	HandleMessage(ctx context.Context, task string, contextID *string) (*protocol.MessageResult, error)
	HandleMessageStream(ctx context.Context, task string, contextID *string) (<-chan protocol.StreamingMessageEvent, error)
}
